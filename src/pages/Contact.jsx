...
export default function Contact() {
  ...
  const validateForm = () => {
    ...
    if (!formData.name) {
      ...
      validationErrors.name = 'Name needs to be minimum 3 characters'
    }
    ...
    if (!formData.email) {
      ...
      validationErrors.name = 'Email needs to be minimum 3 characters'
    }

    if (!formData.subject) {
      validationErrors.subject = 'Subject is required'
    } else if (!formData.subject.length < 3) {
      validationErrors.subject = 'Subject needs to be minimum 3 characters'
    }

    if (!formData.message) {
      validationErrors.message = 'Message is required.'
    } else if (!formData.message.length < 3) {
      validationErrors.message = 'Message needs to be minimum 3 characters'
    }
      ...
      <div className="bg-customGrey shadow-lg">
        <div className="2xl:w-1/3 mx-auto px-10 pt-12 pb-20">
          <div className="bg-white rounded shadow-md p-8">
            ...
            <form
              className="flex items-center flex-col text-left"
            ...
            >
              ...
              <div className="flex flex-col w-full mt-5">
                <label
                  className="flex items-center justify-between font-semibold w-fit"
                  htmlFor="email"
                >
                  Email:
                </label>
              ...
              <div className="flex flex-col w-full mt-5">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`ring-1 py-2 pl-3 mt-2 rounded focus:outline-none focus:ring-black focus:border-0 ${errors.subject ? 'ring-red-500' : 'ring-secondary'}`}
